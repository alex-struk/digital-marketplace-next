...
// carries the form of inactivity only an administrator's deactivation produces, the one
// that offers a reactivation control (R-4.19). Each test reactivates the account afterwards,
// so it is left as it was found.
