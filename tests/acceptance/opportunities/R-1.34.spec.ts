...
// administrator, so the author who is to be confirmed is somebody other than the person who
// published it, and the confirmation can be told from an administrator's own mail.
//
...
// fixture searches by visible recipient only, so a notice that did reach a subscriber would
// not be found and its absence would prove nothing.
