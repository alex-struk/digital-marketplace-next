...
A proposal is a vendor's bid against one procurement opportunity. Each of the three programs —
Code With Us, Sprint With Us, Team With Us — carries its own proposal shape and its own evaluation
stages, but the lifecycle (draft, submit, withdraw, review, score, award) is the same in all three.
...
### D-proposals-35 · v1 · open · recovered
...
### D-proposals-37 · v1 · inferred · recovered
