...
### D-users-1 · v1 · confirmed · recovered
...
### D-users-2 · v1 · inferred · recovered
...
### D-users-4 · v1 · inferred · recovered
...
### D-users-5 · v1 · confirmed · recovered
...
- note: acceptance is remembered twice — as the acceptance that currently stands and as the date terms were last accepted at all; the second survives a later withdrawal of the first (see D-users-25).
...
### D-users-7 · v1 · inferred · recovered
...
### D-users-8 · v1 · inferred · recovered
...
### D-users-9 · v1 · confirmed · recovered
...
### D-users-15 · v1 · confirmed · recovered
...
### D-users-17 · v1 · confirmed · recovered
...
### D-users-20 · v1 · inferred · recovered
...
### D-users-21 · v1 · inferred · recovered
...
### D-users-22 · v1 · confirmed · recovered
...
### D-users-23 · v1 · confirmed · recovered
...
### D-users-24 · v1 · confirmed · recovered
...
### D-users-27 · v1 · confirmed · recovered
...
- note: these routes exist only to let tests sign in, and they bypass the account-status rule in D-users-7. No corrected criterion has been written because how the new system lets tests establish an identity is a decision for its own environment arrangements rather than something to recover from here.
...
### D-users-31 · v1 · confirmed · recovered
