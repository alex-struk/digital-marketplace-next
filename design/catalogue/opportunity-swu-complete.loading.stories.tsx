...
// opportunity-swu-complete · loading — the report has not arrived yet
const meta: Meta = { title: "opportunities/opportunity-swu-complete/loading" };
export default meta;
...
export const Loading: StoryObj = {
  render: () => (
    <div style={page}>
      <Heading level={1}>Sprint With Us opportunity report</Heading>
