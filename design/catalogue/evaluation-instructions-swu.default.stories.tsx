...
// evaluation-instructions-swu · default — an evaluator reads the Sprint With Us evaluation instructions, which are site
// content an administrator edits. Only an evaluator is offered this tab and the Evaluation tab (R-5.34)
const meta: Meta = { title: "evaluation/evaluation-instructions-swu/default" };
export default meta;
  ...
  render: () => (
    <div style={page}>
      ...
      <section aria-labelledby="tab-heading" style={stack}>
        ...
        <Text elementType="p" size="small" color="secondary">
          Illustrative text. The instructions are the Sprint With Us evaluation instructions page of the site's content, which an
        ...
        <div style={stack} data-testid="evaluation-instructions-body">
          ...
          <Text elementType="p">
            Score each proponent's response to each team question on your own, without discussing it with the rest of the panel.
            Nobody else on the panel sees your scores until the consensus stage.
          </Text>
