...
// proposal-twu-create · not-found — anyone who may not start a proposal: public sector staff, an administrator, a
// visitor who is not signed in, or a vendor who has never accepted the service's terms (R-2.1)
const meta: Meta = { title: "proposals/proposal-twu-create/not-found" };
export default meta;
