...
// evaluation-individual-list-swu · default — an evaluator part-way through: one proponent complete, one incomplete, one
// not started. Submission is not offered until every proponent has a complete evaluation (R-5.25, R-5.35)
const meta: Meta = { title: "evaluation/evaluation-individual-list-swu/default" };
export default meta;
...
const rows = [
  ...
  { name: "Proponent 2", status: "Draft: incomplete", action: "Continue evaluation", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000612/team-questions/evaluations/${me}/edit` },
  { name: "Proponent 3", status: "Not started", action: "Start evaluation", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000613/team-questions/evaluations/create` },
];
...
export const Default: StoryObj = {
  render: () => (
    <div style={page}>
      ...
      <div style={row}>
        <Text elementType="p">Status: <span style={badge} data-testid="opportunity-status">Team questions: individual evaluation</span></Text>
      ...
      <section aria-labelledby="tab-heading" style={stack}>
        ...
        <Text elementType="p">
          Score every proponent's team questions on your own. Proponents are listed by their anonymous names. Nobody else on the
          panel sees your scores until the consensus stage.
        </Text>
