...
import { INVALID_PROFILE_ERRORS, PageShell, ProfileScreen, SAMPLE_VENDOR } from "./users.shared";
...
// Saved with the name cleared and a malformed email address (R-4.27).
function UserProfileSelfInvalid() {
  return (
    <PageShell>
      <ProfileScreen
        ids={ids}
...
const meta: Meta<typeof UserProfileSelfInvalid> = {
  title: "users/user-profile-self/invalid",
  component: UserProfileSelfInvalid,
  parameters: { layout: "fullscreen", page: "user-profile-self", route: "/users/me", state: "invalid" },
};

export default meta;

export const Invalid: StoryObj<typeof UserProfileSelfInvalid> = {};
