...
// evaluation-panel-twu · invalid — Save was pressed with the same person named twice and nobody chosen as chair. Nothing
// is saved, and the opportunity keeps the panel it had (R-5.1, R-5.9)
const meta: Meta = { title: "evaluation/evaluation-panel-twu/invalid" };
export default meta;
  ...
  render: () => (
    <div style={page}>
      ...
      <section aria-labelledby="tab-heading" style={stack}>
        ...
        <div tabIndex={-1}>
          <InlineAlert variant="danger" title="The evaluation panel has 2 problems" role="alert">
            <Text elementType="p">The panel was not saved. It is still the panel it was before.</Text>
            <ul>
              <li data-testid="field-error"><Link href="#panel-member-2" data-testid="evaluation-panel-duplicate-error">Evaluator 2: Test Evaluator One is already on the panel</Link></li>
              <li data-testid="field-error"><Link href="#panel-chair" data-testid="evaluation-panel-missing-chair-error">Chair: choose a chair for the panel</Link></li>
            </ul>
          </InlineAlert>
        </div>
        <Form validationBehavior="aria" style={stack}>
          <fieldset style={group} id="panel-member-1" data-testid="evaluation-panel-member-row">
            ...
            <Checkbox aria-label="Chair: evaluator 1" data-testid="evaluation-panel-member-chair">Chair</Checkbox>
            <div>
          ...
          <fieldset style={group} id="panel-member-2" data-testid="evaluation-panel-member-row">
            ...
            <Select
              ...
              defaultValue="u-ps-2"
              isInvalid
              errorMessage="Test Evaluator One is already on the panel. Choose a different person."
          ...
          <Select
            ...
            isInvalid
            errorMessage="Choose a chair. The panel needs one person to record the agreed scores."
