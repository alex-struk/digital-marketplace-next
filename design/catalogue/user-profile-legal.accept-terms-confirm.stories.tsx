...
// user-profile-legal · accept-terms-confirm — the vendor is asked to agree to the updated terms (R-4.16)
const meta: Meta = { title: "users/user-profile-legal/accept-terms-confirm" };
export default meta;
