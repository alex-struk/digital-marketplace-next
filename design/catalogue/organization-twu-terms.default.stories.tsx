...
// organization-twu-terms · default — the owner reading the Team With Us terms for an organization that has not
// accepted them, with Accept offered (R-3.26, R-3.27)
const meta: Meta = { title: "organizations/organization-twu-terms/default" };
export default meta;
...
export const Default: StoryObj = {
  render: () => (
    <div style={page}>
      ...
      <Heading level={1}>Team With Us Terms &amp; Conditions</Heading>
      <section aria-labelledby="terms-heading" style={panel} data-testid="organization-terms-body">
        ...
        <Text elementType="p">[Team With Us terms and conditions text, supplied by the service.]</Text>
      </section>
      <div style={stack}>
        <Text elementType="p">
