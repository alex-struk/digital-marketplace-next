...
// proposal-cwu-export-all · not-found — a vendor or a visitor opens the address. Only public sector staff and
// administrators may take every proposal away (R-2.38)
const meta: Meta = { title: "proposals/proposal-cwu-export-all/not-found" };
export default meta;
