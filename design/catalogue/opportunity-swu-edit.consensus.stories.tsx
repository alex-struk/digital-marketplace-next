...
// opportunity-swu-edit · consensus — at the consensus stage the opportunity's owner or an administrator may finalise
...
const meta: Meta = { title: "opportunities/opportunity-swu-edit/consensus" };
export default meta;
