...
// evaluation-individual-create-swu · invalid — a score above the question's maximum, a score with three decimal places and
// an empty comment. The draft is kept as entered; the problems stop the scores being submitted, not saved (R-5.22, R-5.23)
const meta: Meta = { title: "evaluation/evaluation-individual-create-swu/invalid" };
export default meta;
