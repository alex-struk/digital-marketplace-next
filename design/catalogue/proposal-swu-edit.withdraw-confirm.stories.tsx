...
// proposal-swu-edit · withdraw-confirm — the vendor asked to withdraw their submitted proposal. The dialog says until
// when it can go back in and who will be told. Withdrawing also frees the organization to be changed (R-2.22, R-2.23,
// R-2.36)
const meta: Meta = { title: "proposals/proposal-swu-edit/withdraw-confirm" };
export default meta;
      ...
      <Modal isOpen isDismissable>
        ...
        >
          <Text elementType="p">
            ...
            October 16, 2026 at 4:00 p.m. Pacific time. You and the administrators will be sent a withdrawal notice.
          </Text>
        </AlertDialog>
      </Modal>
    </div>
