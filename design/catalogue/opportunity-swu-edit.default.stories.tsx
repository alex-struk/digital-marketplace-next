...
// opportunity-swu-edit · default — an administrator on a closed opportunity in individual evaluation: the summary with
// its reporting counts, every stage tab, and Edit and Cancel opportunity offered (R-1.28, R-1.29, R-1.30, R-1.56, R-5.34)
const meta: Meta = { title: "opportunities/opportunity-swu-edit/default" };
export default meta;
        ...
        <section aria-labelledby="reporting-heading" style={stack}>
          ...
          <dl style={facts}>
            <div style={fact}>
              ...
              <dd style={detail} data-testid="reporting-views">518</dd>
            </div>
            <div style={fact}>
              <dt style={term}>Watchers</dt>
              <dd style={detail} data-testid="reporting-watchers">21</dd>
            </div>
            <div style={fact}>
              <dt style={term}>Proposals submitted</dt>
              <dd style={detail} data-testid="reporting-proposals">6</dd>
            </div>
          </dl>
        </section>
      </section>
