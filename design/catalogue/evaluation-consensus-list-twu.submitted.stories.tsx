...
// evaluation-consensus-list-twu · submitted — the chair has submitted. Each consensus can still be reopened and submitted
// again until the scores are finalized, unlike an individual evaluation (R-5.30)
const meta: Meta = { title: "evaluation/evaluation-consensus-list-twu/submitted" };
export default meta;
...
const rows = [
  { name: "Proponent 1", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000621/resource-questions/consensus/${chair}/edit` },
  { name: "Proponent 2", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000622/resource-questions/consensus/${chair}/edit` },
  { name: "Proponent 3", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000623/resource-questions/consensus/${chair}/edit` },
];
