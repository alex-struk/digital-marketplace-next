...
// evaluation-individual-create-twu · not-found — anyone who is not an evaluator on the panel, the chair who does not
// evaluate and the owner included, and any evaluator once the opportunity has left individual evaluation (R-5.21)
const meta: Meta = { title: "evaluation/evaluation-individual-create-twu/not-found" };
export default meta;
