...
// user-profile-capabilities · default — a vendor recording their capabilities, one description expanded (R-4.8)
// Capability names and descriptions are illustrative: the spec does not carry the service's list.
const meta: Meta = { title: "users/user-profile-capabilities/default" };
export default meta;
    ...
    <div style={page}>
      ...
      <nav aria-label="Profile sections">
        <ul style={tabs}>
          ...
          <li><Link href={`${base}?tab=capabilities`} aria-current="page" data-testid="profile-tab-capabilities">Capabilities</Link></li>
