...
// evaluation-individual-list-swu · refused — the service found an incomplete evaluation in the set and submitted none of
// it, and says so in its own words. Here the panel's questions changed after the list was loaded (R-5.25, R-5.27 note)
const meta: Meta = { title: "evaluation/evaluation-individual-list-swu/refused" };
export default meta;
...
const rows = [
  { name: "Proponent 1", status: "Draft: complete", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000611/team-questions/evaluations/${me}/edit` },
  { name: "Proponent 2", status: "Draft: incomplete", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000612/team-questions/evaluations/${me}/edit` },
  { name: "Proponent 3", status: "Draft: complete", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000613/team-questions/evaluations/${me}/edit` },
];
