...
// proposal-twu-edit · not-found — another vendor's proposal, or a draft that has been deleted (R-2.4, R-2.24)
const meta: Meta = { title: "proposals/proposal-twu-edit/not-found" };
export default meta;
