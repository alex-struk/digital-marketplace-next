...
// opportunity-list · signed-out — a visitor who has not signed in sees published opportunities and no Watch control (R-1.2, R-1.5)
const meta: Meta = { title: "opportunities/opportunity-list/signed-out" };
export default meta;
...
type Opportunity = {
  ...
  where: string; valueTerm: string; value: string; deadline: string;
};
...
const groups: { key: string; heading: string; order: string; items: Opportunity[] }[] = [
  {
    ...
    items: [
      { id: "7c1e2d40-5b1a-4c2e-9d3f-000000000101", program: "code-with-us", programName: "Code With Us", title: "Build an accessible permit tracker", status: "Published", where: "Victoria · Remote work accepted", valueTerm: "Reward", value: "$45,000", deadline: "October 2, 2026 at 4:00 p.m. Pacific time" },
      { id: "7c1e2d40-5b1a-4c2e-9d3f-000000000201", program: "sprint-with-us", programName: "Sprint With Us", title: "Modernize the licence renewal service", status: "Published", where: "Victoria · Remote work accepted", valueTerm: "Total maximum budget", value: "$1,200,000", deadline: "October 16, 2026 at 4:00 p.m. Pacific time" },
    ],
  },
  {
    key: "closed",
    ...
    items: [
      { id: "7c1e2d40-5b1a-4c2e-9d3f-000000000301", program: "team-with-us", programName: "Team With Us", title: "Data platform team", status: "Resource questions: individual evaluation", where: "Victoria · Remote work accepted", valueTerm: "Maximum budget", value: "$900,000", deadline: "September 11, 2026 at 4:00 p.m. Pacific time" },
      { id: "7c1e2d40-5b1a-4c2e-9d3f-000000000104", program: "code-with-us", programName: "Code With Us", title: "Fix the fisheries licence export", status: "Awarded", where: "Nanaimo · On site only", valueTerm: "Reward", value: "$12,000", deadline: "August 28, 2026 at 4:00 p.m. Pacific time" },
    ],
  },
];
