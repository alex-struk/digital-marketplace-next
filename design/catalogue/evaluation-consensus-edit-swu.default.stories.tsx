...
// evaluation-consensus-edit-swu · default — the chair's draft consensus for a proponent, with the evaluators' scores and
// comments beside each question (R-5.28, R-5.29)
const meta: Meta = { title: "evaluation/evaluation-consensus-edit-swu/default" };
export default meta;
...
const questions = [
  ...
  },
  {
    ...
    min: 6,
    score: 8,
    notes: "The panel agreed the staged cut-over is credible.",
    panel: [
