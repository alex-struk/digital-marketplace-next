...
// evaluation-consensus-list-twu · default — the chair, who is also an evaluator, part-way through agreeing scores. Submitting
// is not offered until every proponent has a complete consensus (R-5.13, R-5.29, R-5.34)
const meta: Meta = { title: "evaluation/evaluation-consensus-list-twu/default" };
export default meta;
...
const rows = [
  { name: "Proponent 1", status: "Draft: complete", action: "Edit consensus", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000621/resource-questions/consensus/${chair}/edit` },
  { name: "Proponent 2", status: "Draft: incomplete", action: "Edit consensus", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000622/resource-questions/consensus/${chair}/edit` },
  { name: "Proponent 3", status: "Not started", action: "Start consensus", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000623/resource-questions/consensus/create` },
];
