...
// /users/me for a signed-in vendor (R-4.26): the same screen as their profile by identifier,
// with the section links addressed through "me".
function UserProfileSelfDefault() {
  return (
    <PageShell>
      <ProfileScreen ids={ids} person={SAMPLE_VENDOR} viewer="own" addressedAsMe activation="deactivate-own" />
    </PageShell>
  );
}

const meta: Meta<typeof UserProfileSelfDefault> = {
  title: "users/user-profile-self/default",
  component: UserProfileSelfDefault,
  parameters: { layout: "fullscreen", page: "user-profile-self", route: "/users/me", state: "default" },
};

export default meta;

export const Default: StoryObj<typeof UserProfileSelfDefault> = {};
