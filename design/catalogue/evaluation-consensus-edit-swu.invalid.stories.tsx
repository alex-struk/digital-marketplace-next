...
// evaluation-consensus-edit-swu · invalid — changes saved with an agreed score above the maximum, one with three decimal
// places and an empty comment (R-5.22, R-5.29 note)
const meta: Meta = { title: "evaluation/evaluation-consensus-edit-swu/invalid" };
export default meta;
...
const questions = [
  {
    ...
    max: 5,
    score: 6,
    notes: "The panel agreed the plan is clear and covers both user groups.",
...
export const Invalid: StoryObj = {
  render: () => (
    <div style={page}>
      <Text elementType="p" size="small" color="secondary">Sprint With Us consensus</Text>
      <Heading level={1}><span data-testid="proposal-proponent-name">Proponent 1</span></Heading>
      <Text elementType="p">Status: <span style={badge} data-testid="evaluation-consensus-status">Draft: incomplete</span></Text>
      <Text elementType="p" size="small" color="secondary">
        The opportunity line, back link and the evaluators' scores are as in the default story and are trimmed here.
      </Text>
      <div tabIndex={-1}>
        <InlineAlert variant="danger" title="This consensus has 3 problems" role="alert">
          <Text elementType="p">Your changes were saved as you entered them. The consensus scores cannot be submitted until these are fixed.</Text>
          <ul>
