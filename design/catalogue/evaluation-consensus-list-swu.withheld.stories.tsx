...
// evaluation-consensus-list-swu · withheld — the opportunity's owner is not on the panel, so the agreed scores are withheld
// until the next stage and the page says why instead of opening empty (R-5.12). Finalizing is still offered (R-5.14; gap 7)
const meta: Meta = { title: "evaluation/evaluation-consensus-list-swu/withheld" };
export default meta;
      ...
      <section aria-labelledby="tab-heading" style={stack}>
        ...
        <div data-testid="evaluation-consensus-withheld-message">
          <InlineAlert
            ...
            description="While the consensus is being agreed, only the evaluation panel can see it, and you are not on this opportunity's panel. The agreed scores appear here once the opportunity moves to the code challenge."
          />
        </div>
      </section>
    </div>
