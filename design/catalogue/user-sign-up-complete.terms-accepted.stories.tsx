...
// The agreement box ticked: the requirement sentence is gone and completion is available.
function UserSignUpCompleteTermsAccepted() {
  return (
    <PageShell>
      <CompleteProfileForm ids={ids} termsAccepted />
    </PageShell>
  );
}

const meta: Meta<typeof UserSignUpCompleteTermsAccepted> = {
  title: "users/user-sign-up-complete/terms-accepted",
  component: UserSignUpCompleteTermsAccepted,
  parameters: {
    layout: "fullscreen",
    page: "user-sign-up-complete",
...
export const TermsAccepted: StoryObj<typeof UserSignUpCompleteTermsAccepted> = {};
