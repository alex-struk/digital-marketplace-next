        ...
        <section aria-labelledby="reporting-heading" style={stack}>
          ...
          <dl style={facts}>
            <div style={fact}>
              ...
              <dd style={detail} data-testid="reporting-views">276</dd>
            </div>
            <div style={fact}>
              <dt style={term}>Watchers</dt>
              <dd style={detail} data-testid="reporting-watchers">9</dd>
            </div>
            <div style={fact}>
              <dt style={term}>Proposals submitted</dt>
              <dd style={detail} data-testid="reporting-proposals">4</dd>
            </div>
          </dl>
        </section>
      </section>
