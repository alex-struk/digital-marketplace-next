  ...
  render: () => (
    <div style={page}>
      ...
      <section aria-labelledby="upload-request" style={stack}>
        ...
        <dl style={facts} data-testid="file-upload-request">
          <div style={fact}>
            ...
            <dd style={detail}>/api/files, sent by a visitor who is not signed in</dd>
          </div>
          <div style={fact}>
      ...
      <section aria-labelledby="upload-answer" style={stack}>
        ...
        <dl style={facts} data-testid="file-upload-refused-signed-out">
          <div style={fact}>
            <dt style={term}>Outcome</dt>
            <dd style={detail}>Refused: not permitted</dd>
          </div>
          <div style={fact}>
            <dt style={term}>Message</dt>
            <dd style={detail}>Sign in to upload a file.</dd>
          </div>
          <div style={fact}>
