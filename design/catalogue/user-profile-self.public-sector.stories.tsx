...
// A public sector employee's own profile: two sections only (R-4.34), a job title (R-4.28),
// and permissions as a read-only label rather than a control (R-4.12).
function UserProfileSelfPublicSector() {
  return (
    <PageShell>
      <ProfileScreen
        ids={ids}
...
const meta: Meta<typeof UserProfileSelfPublicSector> = {
  title: "users/user-profile-self/public-sector",
  component: UserProfileSelfPublicSector,
  parameters: { layout: "fullscreen", page: "user-profile-self", route: "/users/me", state: "public-sector" },
};

export default meta;

export const PublicSector: StoryObj<typeof UserProfileSelfPublicSector> = {};
