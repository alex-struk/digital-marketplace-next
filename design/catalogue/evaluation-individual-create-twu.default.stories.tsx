...
// evaluation-individual-create-twu · default — an evaluator starts scoring the second of three proponents, who is named
// only anonymously. One score and one comment per resource question (R-5.22, R-5.35)
const meta: Meta = { title: "evaluation/evaluation-individual-create-twu/default" };
export default meta;
...
// Illustrative questions and responses.
const questions = [
  {
    n: 1,
...
export const Default: StoryObj = {
  render: () => (
    <div style={page}>
      ...
      <Text elementType="p">
        Score each question between 0 and its maximum, with up to two decimal places, and explain each score in a comment. Your
        draft is saved as you move between proponents. Nothing is shared until you submit your scores for consensus.
      </Text>
