...
// opportunity-cwu-create · administrator — an administrator may publish directly instead of submitting for review;
// no one else is offered Publish (R-1.22, R-1.48)
const meta: Meta = { title: "opportunities/opportunity-cwu-create/administrator" };
export default meta;
