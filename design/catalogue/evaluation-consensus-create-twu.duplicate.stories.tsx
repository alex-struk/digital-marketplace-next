...
// evaluation-consensus-create-twu · duplicate — the chair already recorded a consensus for this proponent and the service
// refuses a second (R-5.29). No wording is given in the spec; this follows R-5.3's (gap 9)
const meta: Meta = { title: "evaluation/evaluation-consensus-create-twu/duplicate" };
export default meta;
    ...
    <div style={page}>
      ...
      <div tabIndex={-1} data-testid="evaluation-duplicate-consensus-error">
        <InlineAlert
          ...
          description="You already have a resource question consensus for this proposal."
        />
      </div>
      <div>
        <Link href="/opportunities/team-with-us/7c1e2d40-5b1a-4c2e-9d3f-000000000301/proposals/3b8d6f20-1a2b-4c3d-8e9f-000000000623/resource-questions/consensus/5e0f7a10-2c3d-4e5f-8a9b-000000000402/edit">
