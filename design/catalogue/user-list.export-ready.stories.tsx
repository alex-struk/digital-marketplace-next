...
// user-list · export-ready — at least one account type and one field chosen, export available (R-4.32)
const meta: Meta = { title: "users/user-list/export-ready" };
export default meta;

const page = { display: "grid", gap: "var(--layout-margin-large)", padding: "var(--layout-padding-large)" } as const;
const dialogBody = { display: "grid", gap: "var(--layout-margin-large)", padding: "var(--layout-padding-large)" } as const;

export const ExportReady: StoryObj = {
  render: () => (
    <div style={page}>
        ...
        <Dialog isCloseable data-testid="contact-list-modal">
          <div style={dialogBody}>
            ...
            <CheckboxGroup
              ...
              isRequired
              defaultValue={["public-sector", "vendor"]}
            >
            ...
            <CheckboxGroup label="Fields" isRequired defaultValue={["email", "organization-name"]}>
            ...
            <ButtonGroup alignment="end" ariaLabel="Export actions">
              ...
              <Button variant="primary" data-testid="contact-list-export-button">Export</Button>
            </ButtonGroup>
          </div>
        </Dialog>
      </Modal>
