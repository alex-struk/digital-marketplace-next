...
// user-profile-legal · default — a vendor whose acceptance of the current terms stands (R-4.33)
const meta: Meta = { title: "users/user-profile-legal/default" };
export default meta;
    ...
    <div style={page}>
      ...
      <nav aria-label="Profile sections">
        <ul style={tabs}>
          ...
          <li><Link href={`${base}?tab=legal`} aria-current="page" data-testid="profile-tab-legal">Legal</Link></li>
        </ul>
      </nav>
