...
// An administrator opening an active public sector employee's account: the profile section
// alone, status shown, details read-only with no edit control (R-4.18, R-4.34), the
// administrator box (R-4.12) and the deactivation control (R-4.30).
...
const meta: Meta<typeof UserProfileDefault> = {
  title: "users/user-profile/default",
  component: UserProfileDefault,
  parameters: { layout: "fullscreen", page: "user-profile", route: "/users/:userId", state: "default" },
};

export default meta;

export const Default: StoryObj<typeof UserProfileDefault> = {};
