...
// opportunity-twu-create · default — a public sector employee starting a new Team With Us opportunity, with its
// resources, resource questions, scoring weights and evaluation panel (R-1.9, R-1.13, R-1.15, R-1.17, R-1.18, R-1.48, R-1.55)
const meta: Meta = { title: "opportunities/opportunity-twu-create/default" };
export default meta;
