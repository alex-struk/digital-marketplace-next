...
// opportunity-cwu-edit · delete-confirm — the author asked to confirm deleting their draft (R-1.28, R-1.53)
const meta: Meta = { title: "opportunities/opportunity-cwu-edit/delete-confirm" };
export default meta;
