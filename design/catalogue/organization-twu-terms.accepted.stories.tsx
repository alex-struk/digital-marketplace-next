...
// organization-twu-terms · accepted — the terms have been accepted for this organization: the date is stated and
// Accept is not offered again (R-3.27)
const meta: Meta = { title: "organizations/organization-twu-terms/accepted" };
export default meta;
