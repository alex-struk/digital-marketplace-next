...
import { ActivationDialog, PageShell, ProfileScreen, SAMPLE_VENDOR } from "./users.shared";
...
// A person chose to deactivate their own account and is asked to confirm (R-4.9). Confirming
// signs them out and sends them to /notice/deactivatedOwnAccount.
function UserProfileSelfConfirmDeactivate() {
  return (
    <PageShell>
      <ProfileScreen
        ids={ids}
        ...
        dialog={<ActivationDialog ids={ids} kind="deactivate-own" />}
      />
    </PageShell>
  );
}

const meta: Meta<typeof UserProfileSelfConfirmDeactivate> = {
  title: "users/user-profile-self/confirm-deactivate",
  component: UserProfileSelfConfirmDeactivate,
  parameters: { layout: "fullscreen", page: "user-profile-self", route: "/users/me", state: "confirm-deactivate" },
};

export default meta;

export const ConfirmDeactivate: StoryObj<typeof UserProfileSelfConfirmDeactivate> = {};
