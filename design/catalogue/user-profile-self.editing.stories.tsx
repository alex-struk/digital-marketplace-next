...
// A vendor editing their own profile: picture, name and email editable; no job title field (R-4.28).
function UserProfileSelfEditing() {
  return (
    <PageShell>
      <ProfileScreen ids={ids} person={SAMPLE_VENDOR} viewer="own" addressedAsMe mode="edit" />
    </PageShell>
  );
}

const meta: Meta<typeof UserProfileSelfEditing> = {
  title: "users/user-profile-self/editing",
  component: UserProfileSelfEditing,
  parameters: { layout: "fullscreen", page: "user-profile-self", route: "/users/me", state: "editing" },
};

export default meta;

export const Editing: StoryObj<typeof UserProfileSelfEditing> = {};
