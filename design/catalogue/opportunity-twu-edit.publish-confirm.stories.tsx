...
// opportunity-twu-edit · publish-confirm — an administrator who pressed Publish on an opportunity under review is asked
// to confirm (R-1.22, R-1.23, R-1.34, R-5.17)
const meta: Meta = { title: "opportunities/opportunity-twu-edit/publish-confirm" };
export default meta;
