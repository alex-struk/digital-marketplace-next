...
// proposal-cwu-export-one · loading — the proposal has not arrived yet
const meta: Meta = { title: "proposals/proposal-cwu-export-one/loading" };
export default meta;
...
export const Loading: StoryObj = {
  render: () => (
    <div style={page}>
      <Heading level={1}>Export a Code With Us proposal</Heading>
