...
// evaluation-individual-list-twu · submitted — the evaluator has submitted; each evaluation can be read but not changed,
// and consensus begins by itself once every evaluator has submitted (R-5.24, R-5.27)
const meta: Meta = { title: "evaluation/evaluation-individual-list-twu/submitted" };
export default meta;
...
const rows = [
  { name: "Proponent 1", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000621/resource-questions/evaluations/${me}/edit` },
  { name: "Proponent 2", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000622/resource-questions/evaluations/${me}/edit` },
  { name: "Proponent 3", href: `${proposals}/3b8d6f20-1a2b-4c3d-8e9f-000000000623/resource-questions/evaluations/${me}/edit` },
];
