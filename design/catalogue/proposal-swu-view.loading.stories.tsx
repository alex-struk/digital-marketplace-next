...
// proposal-swu-view · loading — the proposal has not arrived yet
const meta: Meta = { title: "proposals/proposal-swu-view/loading" };
export default meta;
...
export const Loading: StoryObj = {
  render: () => (
    <div style={page}>
      <Heading level={1}>Sprint With Us proposal</Heading>
