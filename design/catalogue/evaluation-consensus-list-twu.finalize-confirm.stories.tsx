...
// evaluation-consensus-list-twu · finalize-confirm — an administrator pressed Finalize consensus scores in the shared action
// bar and is asked to confirm. The opportunity's owner is offered the same button (R-5.14, R-5.32, R-5.33)
const meta: Meta = { title: "evaluation/evaluation-consensus-list-twu/finalize-confirm" };
export default meta;
    ...
    <div style={page}>
      ...
      <section aria-labelledby="tab-heading" style={stack}>
        ...
        <Text elementType="p">
          ...
          moves up to three proponents who met every minimum score into the challenge. It cannot be undone.
        </Text>
      ...
      <Modal isOpen isDismissable>
        ...
        >
          <Text elementType="p">
            The agreed scores are recorded against each proponent. Up to three of the highest-scoring proponents who met every
            minimum score move into the challenge, and the opportunity moves with them. The chair and the opportunity's owner
            are told. This cannot be undone.
          </Text>
        </AlertDialog>
      </Modal>
    </div>
