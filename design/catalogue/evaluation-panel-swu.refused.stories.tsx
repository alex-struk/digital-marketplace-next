...
// evaluation-panel-swu · refused — the service refused a member the form could not check: the list offers only public
...
const meta: Meta = { title: "evaluation/evaluation-panel-swu/refused" };
export default meta;
