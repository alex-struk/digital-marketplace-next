...
// content-list · default — an administrator in the content area. Every page is listed once, ordered by title, with its
// public address, whether the service needs it, and its created and updated dates (R-7.5). The title opens the page's
// managing screen; the address opens the page as the public reads it.
const meta: Meta = { title: "content/content-list/default" };
export default meta;
...
// Illustrative rows. The service-created pages carry the title their address gave them until somebody rewrites it
// (R-7.12); "Privacy" has been rewritten. "hackathon-rules" is an ordinary page an administrator made.
const pages = [
  ...
  { slug: "hackathon-rules", title: "Hackathon rules", fixed: false, created: ["2026-08-03", "August 3, 2026"], updated: ["2026-09-01", "September 1, 2026"] },
