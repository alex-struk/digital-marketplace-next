...
// evaluation-panel-twu · default — the opportunity's owner sets the panel of a published opportunity: two evaluators, the
// first also the chair (R-5.1, R-5.9, R-5.16, R-5.17, R-5.18)
const meta: Meta = { title: "evaluation/evaluation-panel-twu/default" };
export default meta;
  ...
  render: () => (
    <div style={page}>
      ...
      <section aria-labelledby="tab-heading" style={stack}>
        ...
        <Text elementType="p">
          Once the opportunity closes, each evaluator scores every proponent's resource questions on their own. The chair then
