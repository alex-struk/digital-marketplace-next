...
// opportunity-swu-view · author — its author, who (with administrators) alone sees who created and last changed it,
// and who is not offered Watch on their own opportunity (R-1.5, R-1.29)
const meta: Meta = { title: "opportunities/opportunity-swu-view/author" };
export default meta;
...
export const Author: StoryObj = {
  render: () => (
    <div style={page}>
      ...
      <div>
        <Link href="/opportunities/sprint-with-us/7c1e2d40-5b1a-4c2e-9d3f-000000000201/edit" isButton buttonVariant="secondary">
