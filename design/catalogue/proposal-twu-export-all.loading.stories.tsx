...
// proposal-twu-export-all · loading — the proposals have not arrived yet
const meta: Meta = { title: "proposals/proposal-twu-export-all/loading" };
export default meta;
...
export const Loading: StoryObj = {
  render: () => (
    <div style={page}>
      <Heading level={1}>Export all Team With Us proposals</Heading>
