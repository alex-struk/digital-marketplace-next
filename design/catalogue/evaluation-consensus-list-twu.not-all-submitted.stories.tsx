...
// evaluation-consensus-list-twu · not-all-submitted — finalizing was refused because a proponent still under review has no
// submitted consensus. The alert is the same element as the opportunities domain's advance-refused-message (R-5.13)
const meta: Meta = { title: "evaluation/evaluation-consensus-list-twu/not-all-submitted" };
export default meta;
