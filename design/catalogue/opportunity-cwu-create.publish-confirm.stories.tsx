...
// opportunity-cwu-create · publish-confirm — an administrator who pressed Publish is asked to confirm, because
// publishing notifies everyone who asked to hear of new opportunities (R-1.22, R-1.34, R-1.48)
const meta: Meta = { title: "opportunities/opportunity-cwu-create/publish-confirm" };
export default meta;
...
export const PublishConfirm: StoryObj = {
  render: () => (
    <div style={page}>
      ...
      <TextField label="Title" isRequired defaultValue="Build an accessible permit tracker" data-testid="opportunity-title-field" />
