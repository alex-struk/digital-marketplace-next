...
// An account its owner deactivated: status Inactive, no reactivation control, and a statement
// that the person reactivates it themselves by signing in again (R-4.19).
function UserProfileDeactivatedByOwner() {
  return (
    <PageShell>
      <ProfileScreen
        ids={ids}
...
const meta: Meta<typeof UserProfileDeactivatedByOwner> = {
  title: "users/user-profile/deactivated-by-owner",
  component: UserProfileDeactivatedByOwner,
  parameters: {
    layout: "fullscreen",
    page: "user-profile",
    route: "/users/:userId",
    state: "deactivated-by-owner",
  },
};

export default meta;

export const DeactivatedByOwner: StoryObj<typeof UserProfileDeactivatedByOwner> = {};
