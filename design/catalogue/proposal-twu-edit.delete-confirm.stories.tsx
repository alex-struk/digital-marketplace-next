...
// proposal-twu-edit · delete-confirm — the vendor asked to delete their draft. Deleting is permanent, and afterwards
// the proposal can no longer be opened. Delete is offered only on a draft (R-2.4)
const meta: Meta = { title: "proposals/proposal-twu-edit/delete-confirm" };
export default meta;
