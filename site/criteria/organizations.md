...
| R-3.19 | acceptance/organizations/R-3.19.spec.ts | unbound |
...
| R-3.22 | acceptance/organizations/R-3.22.spec.ts | fail (ruled: adapter-wrong) |
| R-3.23 | acceptance/organizations/R-3.23.spec.ts | fail (ruled: adapter-wrong) |
| R-3.24 | acceptance/organizations/R-3.24.spec.ts | fail (ruled: adapter-wrong) |
...
| R-3.27 | acceptance/organizations/R-3.27.spec.ts | unbound |
| R-3.28 | acceptance/organizations/R-3.28.spec.ts | unbound |
| R-3.29 | — |  |
| R-3.30 | acceptance/organizations/R-3.30.spec.ts | unbound |
